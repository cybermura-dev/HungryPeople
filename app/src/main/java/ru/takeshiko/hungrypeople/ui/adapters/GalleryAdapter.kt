 ...
 *
 * @param images Array of image resource IDs to be displayed in the gallery.
...
class GalleryAdapter(
    ...
    /**
     * Creates a new ViewHolder for the gallery items.
     *
     * @param parent The ViewGroup into which the new View will be added.
     * @param viewType The type of the new View.
     * @return A new ImageViewHolder that holds the View for each gallery item.
     */
    ...
    /**
     * ViewHolder class for gallery items.
     *
     * @param itemView The View that holds the gallery item layout.
     */
